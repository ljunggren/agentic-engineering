...
This starter is step one. As your AI collaboration matures, break it out into a full `.agent/` directory:

- **[Escalation levels](escalation-levels.md)** — when to proceed, inform, propose, or stop
- **[AGENTS.md](agents-md.md)** — single file every tool reads, no duplication across Claude/Cursor/Copilot
- **[Shared context](shared-context.md)** — commit AI memory to the repo, team-wide compounding
- **[Team roles](team-roles.md)** — Scout, Propose, Decide — clear roles for human-AI teams
- **Anti-pattern log** — when your AI makes a mistake, write it down so it never repeats
